...
The TNS configuration file (/etc/outsystems/tnsnames.ora) should be changed to include the chosen TNS name.";
...
#if JAVA
        [UserDefinedConfigurationParameter(Label = "TNS Name", Order = 1, Region = ParameterRegion.AdvancedSession, IsMandatory = true, Prompt = "Session TNS name")]
        ...
        public string SessionTablespace {
            get {
                if (sessionTablespace == null && TableSpaceSuggestor != null) {
                    return TableSpaceSuggestor.GetSuggestion("STATE", "OSSTATE");
                }
