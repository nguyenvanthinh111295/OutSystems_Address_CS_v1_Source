...
namespace OutSystems.HubEdition.DatabaseProvider.Oracle.ConfigurationService {
    ...
    public class DatabaseConfiguration : BaseDatabaseConfiguration {
        ...
        public override bool Equals(object obj) {
            ...
            return ((other != null) && EqualsBasedOnParts(new object[] { Host, Port, ServiceName, DatabaseIdentifier, DbAuthType, Username, Password },
                new object[] {other.Host, other.Port, other.ServiceName, other.DatabaseIdentifier, other.DbAuthType, other.Username, other.Password }));
        }

        public override int GetHashCode() {
            return base.GetHashCode() ^ GetHashCodeBasedOnParts(Host, Port, ServiceName, DatabaseIdentifier, DbAuthType, Username, Password);
        }
        ...
        public override string ConnectionStringOverride {
            ...
            set {
                ...
                _sidMatch = _datasourceJavaSidRegex.Match(_connectionStringOverride);
                if (_sidMatch.Success) {
                    Username = _sidMatch.Groups[1].Value;
                } else {
                    _snMatch = _datasourceJavaServiceNameRegex.Match(_connectionStringOverride);
