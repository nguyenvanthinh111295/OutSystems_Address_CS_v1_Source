...
namespace OutSystems.HubEdition.RuntimePlatform.NewRuntime.Authentication {
    ...
    public class LoginInfo {
        ...
        private bool ValidSignature() {
            return SignatureHelper.SlowEquals(Convert.FromBase64String(httpCookie.HMAC), SignatureHelper.ByteSign(SignatureData, encoding.GetBytes(configuration.HMACKey)));
        }
