...
namespace OutSystems.HubEdition.RuntimePlatform.Processes {
	...
	[System.Web.Services.WebServiceBindingAttribute(Name = "ActivityHandlerSoap", Namespace = "http://tempuri.org/")]
	public class ActivityHandler : System.Web.Services.Protocols.SoapHttpClientProtocol {
		...
		/// <remarks/>
		public ActivityHandler(string url) {
