...
namespace OutSystems.Internal.Db {
    ...
    internal class ManagedCommand : Command {

        public ITransactionManager Manager { get; private set; }

        internal ManagedCommand(ITransactionManager manager, IDbCommand command)
            : base(manager.TransactionService.DatabaseServices.ExecutionService, command) {
            if (manager == null) {
