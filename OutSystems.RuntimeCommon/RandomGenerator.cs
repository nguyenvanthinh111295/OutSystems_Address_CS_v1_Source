...
namespace OutSystems.RuntimeCommon {
    public class RandomGenerator : Random {
        ...
        private RandomGenerator(bool secure, int? seed) {
            IsSecure = secure;
            if (!secure && seed.HasValue) {
        ...
        public static RandomGenerator GetSecureRandomGenerator() {
            return new RandomGenerator(true, null);
        }
        ...
        public static RandomGenerator GetRandomGenerator() {
            return new RandomGenerator(false, null);
        }

        /**
         * Creates a new Random Provider using the provided seed,
         * which can be used for any kind of operations in which security is not an issue
         */
        public static RandomGenerator GetRandomGenerator(int seed) {
            return new RandomGenerator(false, seed);
        }
