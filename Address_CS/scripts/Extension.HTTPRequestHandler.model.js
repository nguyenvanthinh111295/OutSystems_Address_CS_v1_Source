define("Extension.HTTPRequestHandler.model$UserLanguageRec", ["exports", "OutSystems", "Extension.HTTPRequestHandler.model"], function (exports, OutSystems, Extension_HTTPRequestHandlerModel) {
...
UserLanguageRec.fromLocalStorage = function (row, indexRef, attributeOrder) {
...
define("Extension.HTTPRequestHandler.model$UserLanguageRecord", ["exports", "OutSystems", "Extension.HTTPRequestHandler.model", "Extension.HTTPRequestHandler.model$UserLanguageRec"], function (exports, OutSystems, Extension_HTTPRequestHandlerModel) {
var OS = OutSystems.Internal;
...
return [
this.attr("UserLanguage", "userLanguageAttr", "UserLanguage", false, OS.Types.Record, function () {
...
UserLanguageRecord.IsAnonymousRecord = true;
UserLanguageRecord.UniqueId = "0d91522b-fe98-b8e2-225c-65a8c955d8b3";
UserLanguageRecord.fromLocalStorage = function (row, indexRef, attributeOrder) {
...
define("Extension.HTTPRequestHandler.model$RequestFileRec", ["exports", "OutSystems", "Extension.HTTPRequestHandler.model"], function (exports, OutSystems, Extension_HTTPRequestHandlerModel) {
var OS = OutSystems.Internal;
...
this.attr("FileType", "fileTypeAttr", "FileType", true, OS.Types.Text, function () {
return "";
}), 
this.attr("FileSize", "fileSizeAttr", "FileSize", true, OS.Types.Integer, function () {
return 0;
}), 
this.attr("BinaryContent", "binaryContentAttr", "BinaryContent", true, OS.Types.BinaryData, function () {
return OS.DataTypes.BinaryData.defaultValue;
})
].concat(_super.attributesToDeclare.call(this));
};
RequestFileRec.fromLocalStorage = function (row, indexRef, attributeOrder) {
return this.fromLocalStorageImplementation(row, indexRef, OS.Entities.attributeReaderImplementation, attributeOrder);
};
RequestFileRec.init();
...
define("Extension.HTTPRequestHandler.model$RequestFileRecord", ["exports", "OutSystems", "Extension.HTTPRequestHandler.model", "Extension.HTTPRequestHandler.model$RequestFileRec"], function (exports, OutSystems, Extension_HTTPRequestHandlerModel) {
var OS = OutSystems.Internal;
...
return [
this.attr("RequestFile", "requestFileAttr", "RequestFile", false, OS.Types.Record, function () {
...
RequestFileRecord.IsAnonymousRecord = true;
RequestFileRecord.UniqueId = "b9403ff6-84fc-9a29-84e6-29b52108bc4c";
RequestFileRecord.fromLocalStorage = function (row, indexRef, attributeOrder) {
return this.fromLocalStorageImplementation(row, indexRef, OS.Entities.namedAttributeReaderImplementation, attributeOrder);
};
...
define("Extension.HTTPRequestHandler.model$RequestFileRecordList", ["exports", "OutSystems", "Extension.HTTPRequestHandler.model", "Extension.HTTPRequestHandler.model$RequestFileRecord"], function (exports, OutSystems, Extension_HTTPRequestHandlerModel) {
var OS = OutSystems.Internal;
...
RequestFileRecordList.RecordType = Extension_HTTPRequestHandlerModel.RequestFileRecord;
return RequestFileRecordList;
})(OS.DataTypes.GenericRecordList);
Extension_HTTPRequestHandlerModel.RequestFileRecordList = RequestFileRecordList;

});
define("Extension.HTTPRequestHandler.model$UserLanguageRecordList", ["exports", "OutSystems", "Extension.HTTPRequestHandler.model", "Extension.HTTPRequestHandler.model$UserLanguageRecord"], function (exports, OutSystems, Extension_HTTPRequestHandlerModel) {
var OS = OutSystems.Internal;
...
UserLanguageRecordList.RecordType = Extension_HTTPRequestHandlerModel.UserLanguageRecord;
return UserLanguageRecordList;
})(OS.DataTypes.GenericRecordList);
Extension_HTTPRequestHandlerModel.UserLanguageRecordList = UserLanguageRecordList;

});
define("Extension.HTTPRequestHandler.model", ["exports", "OutSystems"], function (exports, OutSystems) {
var OS = OutSystems.Internal;
