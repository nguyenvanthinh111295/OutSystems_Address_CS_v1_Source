...
namespace ssAddress_CS.RestRecords {
	...
	public class JSONENUserEntityRecord: AbstractRESTStructure<ENUserEntityRecord> {
		...
		public static Func<ssAddress_CS.RestRecords.JSONENUserEntityRecord, ENUserEntityRecord> ToStructureDelegate(IBehaviorsConfiguration config) {
			return (ssAddress_CS.RestRecords.JSONENUserEntityRecord s) => ToStructure(s, config);
		}
		...
		public static Func<ENUserEntityRecord, ssAddress_CS.RestRecords.JSONENUserEntityRecord> FromStructureDelegate(IBehaviorsConfiguration config) {
